...
Students at private colleges have the highest SAT scores, averaging around 1,435, which is close to the University of Maryland’s midpoint of 1,465. Public college students score a bit lower, averaging about 1,361, while community college students have the lowest scores at about 1,068. This shows that private colleges usually admit students with higher SAT scores than public or community colleges.
...
Yes. The ANOVA test shows a large, statistically significant difference in SAT scores between public, private, and community colleges (F = 284.3, p < 0.001).

2. Which specific college types differ from each other?

All three types differ significantly. Private colleges have the highest SAT scores, followed by public colleges, and community colleges have the lowest.

3. How large are these differences?

On average, private colleges score about 367 points higher than community colleges, and public colleges score about 293 points higher than community colleges. Private colleges also score about 74 points higher than public colleges.
...
Private colleges lead in SAT scores, far ahead of community and public schools

Lede :

Students at private colleges score much higher on the SAT than those at public or community colleges, according to a new analysis of test data. On average, private college students score about 367 points higher than community college students and roughly 74 points higher than students at public universities. The differences are statistically significant, showing that SAT scores vary widely by college type.
