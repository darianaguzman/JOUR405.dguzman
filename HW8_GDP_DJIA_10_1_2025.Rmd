...
Looking at the scatterplot, there seems to be a strong positive relationship between DJIA and GDP. As the GDP increases, the DJIA also seems to increase. This can suggest that periods of economic growth are often accompanied by higher stock market performance. 

The scatterplot most likely shows that the data points are forming an upward trend -- which means that the two move in the same direction. This can indicate that when the economy performs well (GDP), then the investor confidence and stock prices represented by the DJIA increase too. 
