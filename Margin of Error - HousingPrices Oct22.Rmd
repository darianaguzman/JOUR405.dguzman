...
- plus or minus 10,00    high end: 57.2     low end: 46.8
- plus or minus 3.54     high end: 54.87    low end: 51.1
- plus or minus 5.00.    high end: 57.75    low end: 52.25
...
- The headline is not statistically justified due to the results of the margin of error calculations. 

- Polls show mixed or narrow support toward New City Policy.
...
According to the graph, the previous average for homes was $285k while the average now went over $300k (the mean is 304,500). That is a major increase for current and future home owners. That is a $19.5K increase, with a 6.8% change.

In this case, with transit being introduced -- there will be more competition as the location is more convenient and more attractive to those who will be commuting to their jobs.

Another reason that can influence the price of a home can be when certain expensive grocery stores or restaurants get introduced and built near neighborhoods. This is a way of gentrification towards communities, raising the rent so a specific demographic can move in and "fix" the neighborhood while displacing previous residents who are not able to afford living there which can be blue collar workers and/or overall minorities who are more prone to poverty.  
