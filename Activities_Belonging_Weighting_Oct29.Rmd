...
- How accurately does this reflect the UMD community if only 12,233 UMD community members responded to the survey?
- Gender and race/ethnicity were grouped in ways that might not match how everyone identifies, which could affect how accurate the results are.
- The survey didn’t norm scales to the whole population, and it only shows statistically significant differences. This could make the results less reliable or leave out important experiences
...
- The weights go from 0.23 to 3.04

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:**

- 0.23, This person is over represented in the survey, so their response counts less than one person. 3.04, This person is underrepresented in the survey, so their response counts as more than three people.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:**

- Some groups are less likely to respond to surveys so their answers are given more weight to better reflect the actual population.
...
- Voters who have rarely or never voted, that category shows the biggest change, because their responses are often weighted down to reflect that they are over represented in the survey.

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:**

- If you only report unweighted results, it could make turnout look higher than it really is. Weighting adjusts for over or underrepresented groups, giving a more accurate picture of who is actually likely to vote.
...
- Differences exist because some groups, like rarely voting people, answer surveys more often than they appear in the overall population. Weighting shows that some respondents are overrepresented, or their answers count less, and some are underrepresented -- their answers count more. This helps make the survey results match the real population more closely and accurately.
